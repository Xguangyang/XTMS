...
namespace TMS_Smart_logistics.Model
{
    ...
    {
        public int ReceiptsNvoiceID { get; set; } //应收费用管理ID
        public string ReceiptsNvoiceNo { get; set; }             //发票号
        public string ChargeOwnerOfCargoUnit { get; set; }       //开票单位
        public string ReceiptsNvoiceType { get; set; }           //发票类型
        public Nullable<int> InvoicePrice { get; set; }          //发票金额
        public Nullable<decimal> TaxRate { get; set; }           //税率
