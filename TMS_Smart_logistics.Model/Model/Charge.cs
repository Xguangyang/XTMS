...
namespace TMS_Smart_logistics.Model
{
    ...
    public class Charge
    {
        public int ChargeID { get; set; }                                   //应收费用管理ID
        public string ProfessionalNo { get; set; }                          //业务单号
        public string ChargeOwnerOfCargoUnit { get; set; }                  //货主单位
        ...
        public Nullable<System.DateTime> ProfessionalTime { get; set; }     //业务日期
        ...
        public Nullable<int> ChargeStatus { get; set; }                     ///状态
    }
}
